...
public class CompleteInformationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call.enqueue(new Callback<Example>() {
            ...
            public void onResponse(Call<Example> call, Response<Example> response) {
                ...
                if (a == true) {
                    adultinfoText.setText("Adult- " + "18+");
                } else {
                    adultinfoText.setText("Adult- " + "0+");
                }
                ...
                if (posterpath != null) {
                    Picasso.get().load("https://image.tmdb.org/t/p/w500" + posterpath).fit().into(backdropImageview);
   ...
   /* public void getCastInfo(int movieID)
    {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(BASE_URL)
                .addConverterFactory(GsonConverterFactory.create())
        ...
        CastCrewInterfaceAPI getCast = retrofit.create(CastCrewInterfaceAPI.class);

        Call<CastandCrew> call = getCast.getCastCrew(movieID,APIKEY,"credits");
        call.enqueue(new Callback<CastandCrew>() {
            ...
            public void onResponse(Call<CastandCrew> call, Response<CastandCrew> response) {
                ...
                List<CastandCrew.Cast> cast = castandCrew.getCast();
            ...
            youTubePlayerView.initialize(YOUTUBE_API_KEY,
                new YouTubePlayer.OnInitializedListener() {
                    ...
                    public void onInitializationSuccess(YouTubePlayer.Provider provider,
                        ...
                        youTubePlayer.cueVideos(youtubevideokeys);
                    }
                    @Override
